<%@ Page Title="" Language="C#" MasterPageFile="~/MaterialDesign.master" Theme="SkinFile" AutoEventWireup="true" CodeBehind="RequestFormOld2.aspx.cs" Inherits="ProjectRequest.RequestFormOld2" MaintainScrollPositionOnPostback="true" Debug="true" %>
...
<asp:Content ID="myLogo" ContentPlaceHolderID="logo" runat="server">
    <img src="images/creative-comm-logo.png" alt="Creative Communications Logo">
</asp:Content>
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:Label runat="server" ID="lblStreetAddress" AssociatedControlID="tbStreetAddress" Font-Bold="true">Street Address:</asp:Label>
    </div>

    <div class="input-field col s12 m6 l6">
        <i class="material-icons prefix">phone</i>
        <asp:TextBox runat="server" ID="tbPhoneNumber" ></asp:TextBox>
        <asp:Label runat="server" ID="lblPhoneNumber" AssociatedControlID="tbPhoneNumber" Font-Bold="true">Phone Number:</asp:Label>
    </div>

    <div class="input-field col s12 m6 l6">
        <i class="material-icons prefix">mail</i>
        <asp:TextBox runat="server" ID="tbEmailAddress" ></asp:TextBox>
        <asp:Label runat="server" ID="lblEmailAddress" AssociatedControlID="tbEmailAddress" Font-Bold="true">Email Address:</asp:Label>
    </div>
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:Label runat="server" ID="lblFilmWhen" AssociatedControlID="tbFilmWhen" Font-Bold="true">When’s the party? </asp:Label>
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:Label runat="server" id="lblDueDate" AssociatedControlID="tbDueDate">Due Date:</asp:Label>
    </div>
    ...
    <div class="input-field selectIcon col s12 m6 l6"> 
        ...
        <asp:Label runat="server" ID="lblVendor" AssociatedControlID="ddlVendor" Font-Bold="true">Vendor</asp:Label>
    </div>
...
<%--    <div class="input-field selectIcon col s12 m6 l6">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:Label runat="server" id="lblCost" AssociatedControlID="tbCost">Cost (number only):</asp:Label>
    ...
    <div class="input-field col s12">
        ...
        <asp:Label runat="server" id="lblDetails" AssociatedControlID="tbDetails">Details:</asp:Label>
    </div>
    ...
    <div class="input-field col s12">
        ...
        <asp:Label runat="server" id="lblComments" AssociatedControlID="tbComments">Comments:</asp:Label>
    </div>
